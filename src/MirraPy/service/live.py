...
from ..models.live import Status
...
class LiveService:
    ...
    async def status(self, live_id: str | None = None) -> Status:
        ...
        return Status(alive=is_live_value, collab_enabled=is_collabo, raw=data)
    
    async def join(self, live_id: str | None = None) -> dict[str, Any]:
        target_live_id = Ensure.live_id(self.base, live_id)
    ...
    async def leave(self, live_id: str | None = None) -> dict[str, Any]:
        target_live_id = Ensure.live_id(self.base, live_id)
